...
public class Emerald extends StaticEntity{

	public Emerald(Handler handler, float x, float y) {
	...
	public void render(Graphics g) {
		g.drawImage(Assets.emerald, (int)(x - handler.getGameCamera().getxOffset()) ,
